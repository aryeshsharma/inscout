...
class SearchRequest(BaseModel):
    ...
    provider: Optional[str] = Field(default="search", description="Discovery provider: 'search', 'meta', or 'mock'")
    max_results: Optional[int] = Field(default=100, ge=1, le=500, description="Target results to return (target: 100)")
